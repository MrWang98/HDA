...
from scripts.train_data import train_data
...
if __name__ == "__main__":
    ...
    parser.add_argument('--s_dset_path', type=str, default='./data_s', help="The source dataset path list")
    parser.add_argument('--t_dset_path', type=str, default='./data_t', help="The target dataset path list")
    ...
    if args.task== "UDA":
        config["data"] = {"source":{"list_path":os.path.join('data','UDA_officehome',args.s_dset_path), "batch_size":args.batch_size}, \
                      "target":{"list_path":os.path.join('data','UDA_officehome',args.t_dset_path), "batch_size":args.batch_size}, \
                      "test":{"list_path":os.path.join('data','UDA_officehome',args.t_dset_path), "batch_size":args.batch_size}}
        train_uda(config)
    elif args.task== "SSDA":
